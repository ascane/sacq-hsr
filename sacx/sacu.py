...
class SACU(object):
    def __init__(self,
                 ...
                 tasks,
                 gamma=1.0,
                 num_learn=10,  # TODO -- proper default value
                 steps_per_episode=1000,  # TODO -- proper default value
                 scheduler_period=150,   # TODO -- proper default value
                 num_avg_gradient=10,  # TODO -- proper default value,
                 listeners=None
                 ):
